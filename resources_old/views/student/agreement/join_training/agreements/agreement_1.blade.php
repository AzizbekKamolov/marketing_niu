        ...
        <div class="row">
            ...
            <div class="col-md-12 mt-1 mb-1">
                <p>
                    ...
                    ish yurituvchi rektor v.v.b. Rustambekov Islambek Rustambekovich bir tomondan, va
                    <b>{{date('Y-m-d' , strtotime($student->birthday))}}</b>
                    yilda tugʻilgan <b>{{$student->fio()}}</b>
                    ...
                    bakalavriat 1-kurs bosqichida oʻqitish maqsadida mazkur kontraktni (keyingi oʻrinlarda – Kontrakt)
            ...
            <div class="col-md-12 ">
                <p>
                    ...
                    2023/2024-oʻquv yili hamda 2024/2025-oʻquv yilining bahorgi semestri davomida belgilangan ta’lim
                 ...
                 <p>
                    &nbsp &nbsp &nbsp &nbsp <b>1.2.</b> Talabaning bakalavriat ta'lim yo'nalishini muvaffaqiyatli tamomlash muddati 2025 -yil iyun oyi hisoblanadi.
                </p>
            </div>
            ...
            <div class="col-md-12 mb-1 ">
                <p>
                    ...
                    2023/2024-oʻquv yili hamda 2024/2025-oʻquv yilining bahorgi semestri davomida ta’lim olishini
            ...
            <div class="col-md-12 mb-1 ">
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    2.1.1. 2023/2024-oʻquv yili uchun toʻlov 120 (bir yuz yigirma) bazaviy hisoblash miqdorini tashkil
                    qiladi va quyidagi muddatlarda toʻlanadi: <br>
                    2023-yil 15-oktyabgacha – 30 (oʻttiz) bazaviy hisoblash miqdori; <br>
                    2023-yil 15-dekabrgacha – 30 (oʻttiz) bazaviy hisoblash miqdori; <br>
                    2024-yil 15-fevralgacha – 30 (oʻttiz) bazaviy hisoblash miqdori; <br>
                    2024-yil 01-maygacha – 30 (oʻttiz) bazaviy hisoblash miqdori.

                </p>
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    2.1.2 2024/2025-oʻquv yilining bahorgi semestri uchun toʻlov 80 (sakson) bazaviy hisoblash miqdorini
                    tashkil qiladi va quyidagi muddatlarda toʻlanadi: <br>
                    2025-yil 15-fevralgacha – 40 (qirq) bazaviy hisoblash miqdori; <br>
                    2025-yil 01-maygacha – 40 (qirq) bazaviy hisoblash miqdori.
            ...
            <div class="col-md-12 mb-1">
                ...
                <p>
                    ...
                    yuklab olingan paytdan e’tiboran tuzilgan va kuchga kirgan hisoblanadi. <br>
            ...
            <div class="col-md-12 text-center" style="padding-bottom: 50px">
                ...
                <form id="accept-form" action="{{route('student.agreement.join_training.pdf_agreement')}}" method="post">
                    {{csrf_field()}}
                    {{method_field('POST')}}
