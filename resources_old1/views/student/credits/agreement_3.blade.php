    ...
    <div class="col-md-8 ">
        <div class="row">
            ...
            <div class="col-md-6 text-center text-bold">
                <h4 class="text-bold">
                    Toshkent davlat yuridik universitetida bakalavriat (sirtqi taʻlim shakl ) talabasini qayta oʻqitish
                    uchun
                </h4>
                ...
                <table class="w-100">
                    ...
                    <tr>
                        <td class="w-50" style="width: 49%">
                            ...
                            <p>
                                Buxgalter _______________ I.Ro’zibaev
                            </p>
                            <p>
                                Yuridik byuro
                                katta yuriskonsulti
                                ______________D. Аliboyev
