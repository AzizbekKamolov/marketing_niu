      ...
      <div class="container-fluid">
        <div class="justify-content-center align-items-center d-flex">
          <a class="navbar-brand px-4 justify-content-center align-items-center d-flex" href="/">
            <img src="{{asset('marketing2021/img/logo_white.svg')}}" alt="" width="120" height="65" class="d-inline-block align-text-top color-white">
              <span class="text-white fs-2">Angren Universiteti</span>
          </a>
