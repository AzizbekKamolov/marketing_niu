...
va talabalikka tavsiya etilgan abiturient {{ $data->birthday }} yilda tug‘ilgan {{ $data->fio() }}
(keyingi o‘rinlarda – <b>Talaba</b>) ikkinchi tomondan (birgalikda – Tomonlar), <b>Talaba</b>ni magistratura  davomida o‘qitish maqsadida mazkur ikki tomonlama tabaqalashtirilgan stipendiyasiz shakldagi kontraktni (keyingi o‘rinlarda – Kontrakt)  Oliy va o‘rta maxsus, kasb-hunar ta’limi muassasalarida o‘qitishning to‘lov-kontrakt shakli va undan tushgan mablag‘larni taqsimlash tartibi to‘g‘risidagi nizom (ro‘yxat raqami 2431, 2013 yil 26 fevral), O‘zbekiston Respublikasi Vazirlar Mahkamasining 2019 yil 3 dekabrdagi 967-son qarori, O’zbekiston Respublikasi ta’lim muassasalariga o’qishga qabul qilish bo’yicha Davlat komissiyasining 2020 yil 25 sentyabrdagi 5-son qaroriga muvofiq tuzdilar, Toshkent davlat yuridik universiteti rektorining 2020 yil 16 sentyabrdagi 08-192-son buyrug‘iga muvofiq tuzdilar:
...
<div class="col-md-12 text-center">
    ...
    1. Mazkur Kontraktga asosan <b>Ta’lim muassasasi</b> <b>Talaba</b>ni magistratura bosqichida 2020/2021 o‘quv yili davomida belgilangan ta’lim standartlari va o‘quv dasturlariga muvofiq o‘qitadi, <b>Talaba</b> esa Kontraktning 3-bobida ko’rsatilgan tartib va miqdordagi to‘lovni amalga oshiradi hamda <b>Ta’lim muassasasi</b>da belgilangan tartibga muvofiq ta‘lim olish majburiyatini oladi.
...
2.1. Ta’lim muassasasi ning huquqlari:
<br>
...
<br>
2.2.4. <b>Talaba</b> magistratura bosqichini muvaffaqiyatli tamomlaganda belgilangan tartibda diplom beradi.
<br>
...
<br>
2.4.5. Kontrakt bo‘yicha to‘lovni stipendiyasiz yoki stipendiyali shaklini joriy yilning
1 noyabrga qadar tanlaydi
<br>
...
3.1. 2020/2021 o‘quv yilida Kontrakt bo’yicha <b>Talaba</b> tomonidan to‘lanishi lozim bo‘lgan to‘lov summasi  {{ $data->getAmount()->amount }} ({{ $data->getAmount()->amount_word }}) so‘mni tashkil etadi va Kontraktning ushbu bobida belgilangan tartibda to’lanadi.
<br>
3.2. <b>Talaba</b> o’quv yilining birinchi yarmi uchun {{ $data->getAmount()->part1 }} ({{ $data->getAmount()->part1_word }} ) so‘mni 2020 yilning 1 dekabrgacha to‘laydi.
<br>
3.3. <b>Talaba</b> o’quv yilining ikkinchi yarmi uchun {{ $data->getAmount()->part2 }} ({{ $data->getAmount()->part2_word }} ) so‘mni 2021 yilning 1 martgacha to‘laydi.
<br>
...
5.1. Ushbu Kontraktga asosan majburiyatlarni bajarilmasligi holatlari yengib bo‘kuchlar (fors-major) holatlar natijasida vujudga kelganda Tomonlar o'z majburiyatlarini bajarmaslikdan qisman yoki to'liq ozod bo'ladilar.
<br>
...
<br>
<b>Talaba</b> Kontrakt shartlari bilan norozi bo’lgan taqdirda uch ish kunida, biroq joriy yilning 1 noyabrga qadar murojaat qilishi mumkin. Kontraktni tuzmagan va to’lovlarni amalga oshirmagan Talabani Ta’lim muassasasi talabalar safidan chiqarishga haqli.
...
<form style="display: none" method="post" id="hehe" action="{{ route('shartnoma.super_magister_get') }}">
               {{ csrf_field() }}
