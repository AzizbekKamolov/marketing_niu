    ...
    <div class="col-md-8 ">
        <div class="row">
            ...
            <div class="col-md-12 mb-1">
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    3.1. 2021/2022 o'quv yili kuzgi semestri hisobidan qayta o'qitish uchun Talaba tomonidan bir kredit
                    miqdoriga <b>{{$student->creditPrice->price}}</b> ({{$summa_one_credit_word}}) so'm,
                    jami <b>{{$credits}}</b>-kredit uchun <b>{{$credits*207407}}</b> ({{$summa_word}}) so'mni
                    Shartnomaning ushbu
                    bobida belgilangan tartibda oldindan to'lanadi.
