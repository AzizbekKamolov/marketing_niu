        ...
        <div class="row">
            <div class="col-md-12 text-center text-bold">
                <h4 class="text-bold">
                    ...
                    (stipendiyali shaklda, 1-kurslar uchun)
                </h4>
            ...
            <div class="col-md-12 mt-1 mb-1">
                <p>
                    ...
                    @if($student->birthday)
                        ...
                        yilda
                        tug’ilgan @endif <b>{{$student->fio()}}</b> (keyingi oʻrinlarda – Talaba) uchinchi tomondan
                    (birgalikda –
            ...
            <div class="col-md-12 mb-1">
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    3.1. 2022/2023-oʻquv yilida stipensiyali shaklda ta’lim olish uchun Talaba tomonidan toʻlanishi
