        ...
        <div class="row">
            ...
            <div class="col-md-12 mt-1 mb-1">
                <p>
                    ...
                    056518-sonli litsenziya va Ustaviga asosan faoliyat yuritvuchi <b>“Angren Universiteti” MChJ</b> (keyingi
                    o‘rinlarda «Universitet» deb ataladi) nomidan rektor
                    @include('student.agreements_by_id.show.includes.include_variables') bir tomondan, va {{ $student->fio() }}
                    ikkinchi tomondan (keyingi o’rinlarda - Buyurtmachi) yoki ____________________________________________ nomidan
                    _______________________________ ga asosan ish yurutuvchi
                    ________________________________________________ uchinchi tomondan (keyingi o’rinlarda - Buyurtmachi)
                    va talabalikka tavsiya etilgan abituriyent {{ $student->fio() }}
                    (keyingi o’rinlarda - Talaba), birgalikda Tomonlar),<b>60410400-Moliya va moliyaviy texnologiyalar ta`lim</b>
                    yo‘nalishi bo‘yicha Talabani bakalavriat 1-kurs 1-semestr davomida o‘qitish
