        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center text-bold">
                <h4 class="text-bold">
                    ...
                    uch tomonlama KONTRAKT (sirtqi ta’lim shaklda, {{$student->course}} - kurslar uchun)
                </h4>
            ...
            <div class="col-md-12 mt-1 mb-1">
                ...
                <div style="padding: 0; margin: 0;  width: 100%;">
                    ...
                    <div style="display: inline-block; width: 18%; text-align: end;"> &nbsp; (keyingi o’rinlarda –
                        Tashkilot)
                    </div>
                </div>
                ...
                rektorining 2021 yil 1 sentyabrdagi 02- -son buyrug‘iga muvofiq tuzdilar:
            ...
            <div class="col-md-12 mb-1">
                <p>
                    ...
                    to’lov summasi <b>10 960 400</b> (O’n million to‘qqiz yuz oltmish ming to`rt yuz ) so‘mni tashkil
                    etadi va
                ...
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    3.2. Talaba kuzgi semestr uchun 5 480 200 (besh million to‘rt yuz sakson ning ikki yuz ) so‘mni
                ...
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    3.3. Talaba bahorgi semestr uchun 5 480 200 (besh million to‘rt yuz sakson ning ikki yuz ) so‘mni
                    quyidagi muddatlarda to‘laydi:
