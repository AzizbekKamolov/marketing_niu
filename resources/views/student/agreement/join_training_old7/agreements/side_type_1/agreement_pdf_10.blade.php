        ...
        <div class="row">
            ...
            <div class="col-md-12 mt-1 mb-1">
                ...
                <p>
                    ...
                    nomidan Ustavga asosan @include('student.agreements_by_id.show.includes.include_variables') bir tomondan, va ______________________
                    yilda tug‘ilgan
                    <b>{{$student->fio()}}</b>
            ...
            <div class="col-md-12 mb-1 ">
                ...
                <p>
                    2022-yil 15-noyabrgacha – 8 625 000,0 (sakkiz million olti yuz yigirma besh ming) soʻm; <br>
