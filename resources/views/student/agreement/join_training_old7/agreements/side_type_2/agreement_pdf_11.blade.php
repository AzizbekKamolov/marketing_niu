    ...
    <div class="col-md-8 ">
        <div class="row">
            ...
            <div class="col-md-6 text-center text-bold">
                <h4 class="text-bold">
                    Mutaxassisni qoʻshma taʻlim dasturi boʻyicha tayyorlash haqida uch tomonlama
                    KONTRAKT
                    <br>
            ...
            <div class="col-md-12 mt-1 mb-1">
                <p>
                    ...
                    ikkinchi tomondan
                    <b>{{$student->fio()}}</b>
                    (keyingi oʻrinlarda – Talaba), uchinchi tomondan, (birgalikda – Tomonlar) “Yurisprudensiya (faoliyat
                    turlari boʻyicha)” taʻlim yoʻnalishi doirasida Qozogʻiston Respublikasi M.S.Narikbayev nomidagi
                    KAZGYU universiteti (keyingi oʻrinlarda – KAZGYU) bilan tuzilgan qoʻshma taʻlim dasturi boʻyicha
            ...
            <div class="col-md-12 mb-1 ">
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    <b>2.1.</b> . KAZGYU bilan tuzilgan qoʻshma taʻlim dasturi boʻyicha taʻlim olish joylari
                ...
                @include('student.agreement.join_training.agreements.11_table')
                <br>
                * mazkur summa miqdori O‘zbekiston Respublikasi belgilangan bazaviy hisoblash miqdorining 115 baravar
                miqdoridan kelib chiqib belgilangan.
                <br>
                ** mazkur summa miqdori O‘zbekiston Respublikasi belgilangan bazaviy hisoblash miqdorining 77 baravar
                miqdoridan kelib chiqib belgilangan.
            ...
            <div class="col-md-12 mb-1 ">
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    <b>2.3.</b>KAZGYU bilan tuzilgan qoʻshma taʻlim dasturi boʻyicha Kontraktni stipendiyasiz shakldan
            ...
            <div class="col-md-12 mb-1">
                ...
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    3.2.4.Talaba tomonidan toʻlangan yoki tijorat banki tomonidan taʻlim krediti boʻyicha oʻtkazilgan va
                    KAZGYUga tegishli boʻlgan toʻlov-kontrakt miqdorini KAZGYUga oʻtkazadi. Bunda KAZGYU va Talaba
                    o‘rtasida tuzilgan shartnomada KAZGYUga tegishli bo‘lgan oʻqitishning toʻlov miqdorlari 200 000
                    (ikki yuz ming) Rossiya rubl miqdorida belgilanganligini inobatga olgan holda mablagʻlarni xorijiy
                ...
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    3.2.5.Talaba KAZGYU bilan tuzilgan qoʻshma taʻlim dasturi boʻyicha bakalavriat yoʻnalishini
                    muvaffaqiyatli tamomlaganda belgilangan tartibda diplom beradi.
                </p>
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    3.2.6.KAZGYUning xatiga asosan Talabani talabalar safiga kiritadi.
                </p>
            </div>
            <div class="col-md-12 mb-1">
                <p>
            ...
            <div class="col-md-12 mb-1">
                ...
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    4.6.Talaba Taʻlim muasasasining talabalari safidan chiqarilganda KAZGYUning talabalari safidan ham
                    avtomatik ravishda chiqariladi, shuningdek Talaba KAZGYUning talabalari safidan chiqarilganda Taʻlim
            ...
            <div class="col-md-12 mb-1">
                ...
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    6.6.KAZGYU va Talaba oʻrtasida taʻlim olish va tegishli hisob-kitoblarni amalga oshirish boʻyicha
                    alohida toʻlov-kontrakt shartnomasi tuziladi. Bunda KAZGYU va Talaba oʻrtasida tuzilgan
                    shartnomaning shartlari mazkur Kontrakt shartlari oʻrtasida tafovutlar boʻlgan taqdirda KAZGYU va
                    Talaba oʻrtasida tuzilgan shartnomaning shartlari qoʻllaniladi (shu jumladan mazkur Kontraktning
                    2.1-bandida koʻrsatilgan oʻqitishning toʻlov miqdorlari).
