                ...
                <div class="container-fluid">
                    <div class="row g-2">
                        ...
                        <div class="col-md-8">
                            ...
                            <form action="{{ route('student.agreement.join_training.get_data') }}" method="post"
                                  name="super-form"
                                  class="register-form" id="register-form">
                                {{ @csrf_field() }}
                                {{method_field('POST')}}
                                <div class="col-12">
                                    <label for="validationDefaultUsername" class="form-label">Id kod</label>
                                ...
                                <div class="col-12 my-4">
                                    <button class="btn btn-primary text-center w-25" type="submit">Shartnomalarni
                                        ko'rish
                                    </button>
                                </div>
                            </form>
