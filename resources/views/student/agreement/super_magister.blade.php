                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-8">
                                <div class="text-center">
                                    <h1 class="colorSix fw-bold fs-4">Magistratura uchun tabaqalashtirilgan to'lov shartnomasini olish</h1>
                                ...
                                <form action="{{ route('student.agreement.get_data') }}" method="post" name="super-form"
                                    ...
                                    {{method_field('POST')}}
                                    <div class="col-12">
                                        <input type="text" hidden name="type" value="super_magister">
