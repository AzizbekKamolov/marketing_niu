                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div style="display: flex; justify-content: space-between; padding-bottom: 15px;">
                            ...
                            <div>
                                @if(Auth::user()->role == 13)
                                    {{--                                    <a href="{{ route('super.edit' , ['id' => $data->id]) }}" class="btn btn-link">O'zgartirish--}}
                                    {{--                                        <i class="fa fa-edit" aria-hidden="true"></i></a>--}}
                                    <a href="{{ route('super.index') }}" class="btn btn-info">Ro'yhat <i
                        ...
                        <div class="row">
                            ...
                            {{--                            <div class="col-md-4 form-group">--}}
                            {{--                                <label>Jinsi <span class="error">  @if ($errors->has('gender'))--}}
                            {{--                                            | {{ $errors->first('gender') }} @endif </span></label>--}}
                            {{--                                <div style="display: flex; justify-content: space-around; width: 100%;">--}}
                            {{--                                    <div>--}}
                            {{--                                        <label>Erkak</label>--}}
                            {{--                                        <input readonly="true" disabled="true" type="radio" name="gender"--}}
                            {{--                                               @if($data->gender == 1) checked="true" @endif  value="1">--}}
                            {{--                                    </div>--}}
                            {{--                                    <div>--}}
                            {{--                                        <label>Ayol</label>--}}
                            {{--                                        <input readonly="true" disabled="true" type="radio" name="gender"--}}
                            {{--                                               @if($data->gender == 0) checked="true" @endif value="0">--}}
                            {{--                                    </div>--}}
                            {{--                                </div>--}}
                            {{--                            </div>--}}
                            ...
                            {{--                            <div class="col-md-4 form-group">--}}
                            {{--                                <label>Viloyat <span class="error">  @if ($errors->has('region'))--}}
                            {{--                                            | {{ $errors->first('region') }} @endif </span></label>--}}
                            {{--                                <input type="text" readonly="true" class="form-control" value="{{ $data->viloyat }}"--}}
                            {{--                                       name="">--}}
                            {{--                            </div>--}}
                            {{-- <div class="col-md-4 form-group">
                            ...
                            {{--                            <div class="col-md-4 form-group">--}}
                            {{--                                <label>Tuman <span class="error">  @if ($errors->has('area'))--}}
                            {{--                                            | {{ $errors->first('area') }} @endif </span></label>--}}
                            {{--                                <input type="text" readonly="true" class="form-control" value="{{ $data->tuman }}"--}}
                            {{--                                       name="">--}}

                            {{--                            </div>--}}
                            <div class="col-md-4 form-group">
                                <label>Manzili <span class="error">  @if ($errors->has('address'))
                            ...
                            <div class="col-md-4 " style="padding-left: 15px !important; ">
                                <div class="form-group">
                                    <label>Pasport seriasi va raqami <span class="error">  @if ($errors->has('passport_seria'))
                                                | {{ $errors->first('passport_seria') }} @endif @if ($errors->has('passport_number')) {{ $errors->first('passport_number') }} @endif </span></label>
                                    <div style="display: flex;">
                                        <div class="col-md-4">
                                            <input readonly="true" type="text" name="passport_seria"
                                                   class="form-control"
                                                   value="@if(old('passport_seria')){{ old('passport_seria') }}@else{{ $data->passport_serial }}@endif">
                            ...
                            <div class="col-md-4 form-group">
                                <label>DTM ID raqami<span class="error">  @if ($errors->has('passport_given_date'))
                                ...
                                <input readonly="true" type="text" name="passport_given_date" class="form-control"
                                       value="@if(old('passport_given_date')){{ old('passport_given_date') }}@else{{ $data->dtm_id }}@endif">
                            </div>
                            {{--  <div class="col-md-4 form-group">
                            ...
                            <div class="col-md-4 form-group">
                                <label>Tanlagan yo'nalishi <span class="error">  @if ($errors->has('passport_issued_date'))
                                            | {{ $errors->first('passport_issued_date') }} @endif </span></label>
                        ...
                        <div class="row">
                            <div class="col-md-4 form-group">
                                <label>To'plagan bali <span class="error">  @if ($errors->has('passport_issued_date'))
                                            | {{ $errors->first('passport_issued_date') }} @endif </span></label>
                                <input readonly="true" type="text" name="passport_issued_date" class="form-control"
                                       value="@if(old('passport_issued_date')){{ old('passport_issued_date') }}@else{{$data->ball}}@endif">
                            </div>
                            <div class="col-md-4 form-group">
                                <label>O'tish bali <span class="error">  </span></label>
                                <input readonly="true" type="text" name="passport_issued_date" class="form-control"
                                       value="@if(old('passport_issued_date')){{ old('passport_issued_date') }}@else{{$data->passed_ball}}@endif">
                            </div>
                            <div class="col-md-4 form-group">
                                <label>Yetmagan ball <span class="error">  </span></label>
                                <input readonly="true" type="text" name="passport_issued_date" class="form-control"
                                       value="@if(old('passport_issued_date')){{ old('passport_issued_date') }}@else{{$data->difference_ball}}@endif">
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                {!! $passed_ball ? $passed_ball->table_html :'' !!}
                            </div>
                        </div>
