...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form action="{{route('super.lyceum.update.parent.data' , ['id' => $data->id])}}" method="POST">
                        {{csrf_field()}}
                        {{method_field('PUT')}}
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" name="id_code_marketing" class="form-control"
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <div class="d-flex">
                                        <input type="text" name="parent_pass_seria" class="form-control"
                                               value="@if(old('parent_pass_seria')){{ old('parent_pass_seria') }}@else{{ $data->parent_pass_seria }}@endif"
                                               style="width: 30%">
                                        <input type="text" name="parent_pass_number" class="form-control"
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input readonly="true" type="text" name="passport_given_date" class="form-control"
                                           value="@if(old('passport_given_date')){{ old('passport_given_date') }}@else{{ $data->id_code }}@endif">
                                </div>
...
@section('js')
    <script>
        $('input[name="parent_pass_seria"]').inputmask({
            'mask': 'AA',
        });
        $('input[name="parent_pass_number"]').inputmask({
            'mask': '9999999',
        });
        $('input[name="phone"]').inputmask({
            'mask': '+\\9\\98\\999999999',
        });
        $('input[name="id_code_marketing"]').inputmask({
            'regex': '[0-9]{7}',
        });
    </script>
