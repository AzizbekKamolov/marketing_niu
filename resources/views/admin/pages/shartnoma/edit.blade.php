                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div style="display: flex; justify-content: space-between; padding-bottom: 15px;">
                                      ...
                                      <div>
                                         <a href="{{ route('student.show' , ['id' => $data->id]) }}" class="btn btn-link">Ko'rish <i class="fa fa-eye" aria-hidden="true"></i></a>
                                  ...
                                  {{ method_field('put') }}
                                      ...
                                      <div class="row">
                                        <div class="col-md-4 form-group">
                                          ...
                                          <input type="text" name="id_code"  class="form-control number-inputmask" value="@if(old('id_code')){{ old('id_code') }}@else{{ $data->id_code }}@endif">
                                        </div>
                                        <div class="col-md-4 form-group">
                                        ...
                                        <div class="col-md-4 " style="padding-left: 15px !important; ">
                                          <div class="form-group">
                                            ...
                                            <div style="display: flex;">
                                              <div class="col-md-4">
                                                <input type="text" name="passport_seria" class="form-control" value="@if(old('passport_seria')){{ old('passport_seria') }}@else{{ $data->passport_seria }}@endif">
                                      ...
                                      <div class="row">
                                         <div class="col-md-4 form-group border p-3">
                                          ...
                                          <div style="display: flex; justify-content: space-around; width: 100%;">
                                            ...
                                            <input type="radio" name="shartnoma_type" @if($data->step == 1) checked="true" @endif   value="1">
                                            </div>
                                            <div >
                                              <label>Stipendiyasiz</label>
                                            <input type="radio" name="shartnoma_type"  @if($data->step == 2) checked="true" @endif    value="2">
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      @if($first || $magister)
                                      <div class="col-md-8" >
                                        <select class="form-control" name="type_student">
                                          <option value="mag" @if($magister) selected="true" @endif>Magister oddiy</option>
                                          <option value="bak" @if($first) selected="true" @endif>Bakalavr 1-kurs</option>
                                        </select>
