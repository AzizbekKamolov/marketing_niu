            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="student_create" action="{{route('payment_admin.student.store')}}" class="form1"
                              method="post">
                            {{csrf_field()}}
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input required type="text" class="form-control" name="id_code"
                                                   value="@if(old('id_code')){{old('id_code')}}@endif">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                                Ism
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" class="form-control" name="middle_name"
                                                   value="@if(old('middle_name')){{old('middle_name')}}@endif">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                                Tug'ilgan sana
                                            ...
                                            <input required type="date" class="form-control" name="birthday"
                                                   value="@if(old('birthday')){{old('birthday')}}@endif">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 form-group">
                                            ...
                                            <select name="gender" id="" class="form-control">
                                                <option @if(old('gender') == '1') selected @endif  value="1">Erkak
                                                </option>
                                                <option @if( old('gender') == '0') selected @endif  value="0">Ayol
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <select name="area" id="" class="form-control">
                                                ...
                                                @if(old('region'))
                                                    ...
                                                    @endphp
                                                    @foreach($ar as $item)
                                                        <option @if(old('area')==$item->id) selected
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="date" class="form-control" name="passport_given_date"
                                                   value="@if(old('passport_given_date')){{old('passport_given_date')}}@endif">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                            ...
                                            <input type="date" class="form-control" name="passport_issued_date"
                                                   value="@if(old('passport_issued_date')){{old('passport_issued_date')}}@endif">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                            ...
                                            <input type="text" class="form-control" name="passport_given_by"
                                                   value="@if(old('passport_given_by')){{old('passport_given_by')}}@endif">
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
