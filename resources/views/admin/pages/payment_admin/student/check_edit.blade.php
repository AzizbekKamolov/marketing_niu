                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{route('payment_admin.student.update' , ['id' => $data->id])}}" class="form1" method="post">
                                    {{csrf_field()}}
                                    {{method_field('put')}}
                                <div class="table-responsive" style="overflow-x: unset">
                                    <div class="row">
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" class="form-control" name="id_code" value="@if(old('id_code')){{old('id_code')}}@else{{$data->id_code}}@endif">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                                Ism
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="date" class="form-control" name="birthday" value="@if(old('birthday')){{old('birthday')}}@else{{$data->birthday}}@endif">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                                Telefon
                                            ...
                                            <input type="text" class="form-control" name="phone" value="@if(old('phone')){{old('phone')}}@else{{$data->phone}}@endif">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                                Viloyat
                                        ...
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                                ...
                                                <div style="display: flex; margin-top: 7px;" >
                                                    <input type="text" class="form-control" style="width: 30%" name="passport_seria" value="@if(old('passport_seria')){{old('passport_seria')}}@else{{$data->passport_seria}}@endif">
                                                    <input type="text" class="form-control" style="width: 70%" name="passport_number" value="@if(old('passport_number')){{old('passport_number')}}@else{{$data->passport_number}}@endif">
                                                </div>
                                            </label>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="date" class="form-control" name="passport_given_date" value="@if(old('passport_given_date')){{old('passport_given_date')}}@else{{$data->passport_given_date}}@endif">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                            ...
                                            <input type="date" class="form-control" name="passport_issued_date" value="@if(old('passport_issued_date')){{old('passport_issued_date')}}@else{{$data->passport_issued_date}}@endif">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                            ...
                                            <input type="text" class="form-control" name="passport_given_by" value="@if(old('passport_given_by')){{old('passport_given_by')}}@else{{$data->passport_given_by}}@endif">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                                Jinsi
