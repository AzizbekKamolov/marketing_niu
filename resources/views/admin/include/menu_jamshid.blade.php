...
@if(Auth::user()->role == 6 )
    ...
    <li class="sidebar-item"><a class="sidebar-link active" href="/backoffice/student" aria-expanded="false"><i
                data-feather="home" class="feather-icon"></i><span class="hide-menu">Barcha Talabalar</span></a></li>
...
@if(Auth::user()->role == 7)
    ...
    <li class="sidebar-item"><a class="sidebar-link " href="/backoffice/super" aria-expanded="false"><i
                data-feather="tag" class="feather-icon"></i><span class="hide-menu">Superkontrakt <br> (bakalavr)</span></a>
    </li>
...
@if(Auth::user()->role == 9)
    ...
    <li class="sidebar-item"><a class="sidebar-link active" href="{{route('attendance.all')}}" aria-expanded="false"><i
                data-feather="tag" class="feather-icon"></i><span class="hide-menu">Barcha davomatlar </span> </a></li>
...
@if(Auth::user()->role == 11)
    <li class="sidebar-item @if(Request::is('backoffice/payment-admin-students')) selected @endif"><a
            class="sidebar-link  " href="{{route('payment_admin.student.index')}}" aria-expanded="false"><i
                data-feather="tag" class="feather-icon"></i><span class="hide-menu">Barcha talabalar </span> </a></li>
...
@if(Auth::user()->role == 12)
    <li class="sidebar-item @if(Request::is('backoffice/ttj-admin/ttj-admin-students')) selected @endif"><a
            class="sidebar-link  " href="{{route('ttj_admin.students')}}" aria-expanded="false"><i
                data-feather="tag" class="feather-icon"></i><span class="hide-menu">Barcha talabalar </span> </a></li>
    <li class="sidebar-item bg-success text-white"><a class="sidebar-link text-white" href="{{route('ttj_admin.students.type' , ['type' => 1])}}"
                                aria-expanded="false"><i data-feather="tag" class="feather-icon text-white"></i><span
                class="hide-menu">Ruxsat berilganlar </span> </a></li>
    <li class="sidebar-item bg-orange text-white"><a class="sidebar-link text-white" href="{{route('ttj_admin.students.type' , ['type' => 0])}}" aria-expanded="false"><i
                data-feather="tag" class="feather-icon text-white"></i><span class="hide-menu">Ruxsat berilmaganlar </span> </a></li>
