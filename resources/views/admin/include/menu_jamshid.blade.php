...
{{--                data-feather="tag" class="feather-icon"></i><span class="hide-menu">Stipendiyalar </span> </a></li>--}}
    ...
    <li class="sidebar-item"><a class="sidebar-link " href="{{route('credit_prices.index')}}"
                                aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
...
@endif
@if(in_array(auth()->user()->role, [11, 777]))
    <li class="sidebar-item"><a class="sidebar-link " href="{{route('get.payment.history')}}"
                                aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
                    class="hide-menu">To'lovlar</span> </a></li>
@endif
