                            ...
                            <div
                                ...
                                <div class="row">
                                    <h5 class="card-title fs-5 fw-bold colorFour text-center">To'lov shartnomalarini
                                        olish <br> <span style="color: red !important;">(Vaqtinchalik to'xtatildi)</span></h5>
                                </div>
                            </div>
                        </a>
                            ...
                            <div
                                ...
                                <div class="row">
                                    <h5 class="card-title fs-5 fw-bold colorFour text-center">Tabaqalashtirilgan
                                        to'lov-shartnoma asosida o'qish uchun ariza topshirish  <br> <span style="color: red !important;">(Vaqtinchalik to'xtatildi)</span> </h5>
