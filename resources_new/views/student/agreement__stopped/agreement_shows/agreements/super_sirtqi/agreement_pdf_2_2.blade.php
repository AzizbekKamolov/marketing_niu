        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center text-bold">
                <h4 class="text-bold">
                    ...
                    uch tomonlama tabaqalashtirilgan KONTRAKT (sirtqi ta’lim shaklda, {{$student->course}} - kurslar uchun)
                </h4>
...
{{--            <div class="col-md-6 text-right"><p>{{$year}} yil “{{$day}}” {{$month}}</p></div>--}}
            <div class="col-md-12 mt-1 mb-1">
                ...
                <div style="padding: 0; margin: 0;  width: 100%;">
                    <div style="display: inline-block; width: 36%;">Rustambekovich bir tomondan, &nbsp;</div>
                ...
                <div style="padding: 0; margin: 0;  width: 100%;">
                    <div style="display: inline-block; width: 40%; text-align: end;"> &nbsp; (keyingi o’rinlarda – Tashkilot)</div>
                    <div style="display: inline-block; width: 10%;">nomidan &nbsp;</div>
                    <br><br>
                    <div style="display: inline-block; width: 100%;  padding-top: 20px; margin-top: 30px !important;"></div>
                    <div style="display: inline-block; width: 100%; border-bottom: 1px solid black; padding-top: 20px"></div>
                </div>
                <span style="font-size: 11px; text-align:center; display: block;"> (vakolat beruvchi hujjat turi)</span>

                 <div style="padding: 0; margin: 0;  width: 100%;">
                    <div style="display: inline-block; width: 36%; text-align: end;"> &nbsp;asosan ish yurituvchi</div>
                    <div style="display: inline-block; width: 60%; border-bottom: 1px solid black;"></div>
                </div>
                <span style="font-size: 11px; text-align:center; display: block;"> (rahbarning familiyasi, ismi, sharifi, lavozimi)</span>
                    <div style="display: inline-block; width: 30%; text-align: end;"> &nbsp;ikkinchi tomondan,</div>
                ...
                to’g’risidagi nizom (ro’yxat raqami 2431, 2013 yil 26 fevral), O‘zR Vazirlar Mahkamasining 2019 yil 3
                dekabrdagi 967-son, 2021 yil 10 iyundagi 359-son qarorlari, Toshkent davlat yuridik universiteti
                rektorining 2021 yil 13 sentyabrdagi 02-252-son buyrug‘iga muvofiq tuzdilar:
...
{{--            </div>--}}
            <div class="col-md-12 mb-1">
                <p>
                    ...
                    3.1. 2021/2022 o‘quv yilida sirtqi ta’lim olish uchun Talaba tomonidan to‘lanishi lozim bo‘lgan
                    to’lov summasi <b>{{$student->all_summa}}</b> ({{$student->all_summa_word}}) so‘mni tashkil etadi va
                    Kontraktning ushbu bobida belgilangan tartibda to’lanadi.
                </p>
                <p>
                    &nbsp &nbsp &nbsp &nbsp
