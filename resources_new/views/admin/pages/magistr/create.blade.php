                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div style="display: flex; justify-content: space-between; padding-bottom: 15px;">
                                      <div>
                                          <h4 class="card-title">Talaba qo'shish (magistr)</h4>
                                      </div>
                                      <div>
                                         <a href="{{ route('student_magistr') }}" class="btn btn-info">Ro'yhat <i class="fa fa-list" aria-hidden="true"></i></a>
                                      </div>
                                ...
                                <form action="{{ route('student_magistr') }}" method="post" >
                                  {{ csrf_field() }}
                                      ...
                                      <div class="row">
                                        <div class="col-md-4 form-group">
                                          ...
                                          <input type="text" name="id_code"  class="form-control number-inputmask" value="{{ old('id_code') }}">
                                        </div>
                                         <div class="col-md-4 form-group">
