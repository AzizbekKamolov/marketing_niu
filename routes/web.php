...
// SUPER
    ...
    Route::get('/example-import-students', function () {
        return response()->download(public_path('files/example_import_student.xlsx'));
    ...
    Route::get('get-payment-history/{id}', 'StudentPaymentController@edit')->name('payment.history.edit');
    Route::put('update-payment-history/{id}', 'StudentPaymentController@update')->name('payment.history.update');
    ...
    Route::post('import-payment-history', 'StudentPaymentController@import')->name('payment_admin.import.payment.history');
