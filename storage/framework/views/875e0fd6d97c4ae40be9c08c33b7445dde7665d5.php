...
ikki tomonlama KONTRAKT ( <?php if($data->step == 1 ): ?> stipendiyali <?php else: ?> stipendiyasiz <?php endif; ?>  shaklda, 2,3 va 4-kurslar uchun)
    </p>
    <p class="center bold">
        № ______
<br>
ID: 002-00<?php echo e($data->id_code); ?>
    ...
    <div >
        ...
        <div class="abs2">
            ...
            <br/>
                ...
                Pasport seriyasi <?php echo e($data->passport_seria); ?> raqami <?php echo e($data->passport_number); ?>

            <br/>
            Tel: <?php echo e($data->phone); ?>

            <br>
            Imzo __________

        <p class="center bold text-center w-100">

           <button class="tasdiq btn btn-success mt-3 " >
                Men , Talaba <b><?php echo e($data->fio()); ?></b> , Toshkent davlat yuridik universitetida o'qitish uchun Kontrakt mazmuni bilan to'liq tanishdim va uning shartlariga roziman hamda shaxsiy ma`lumotlarim to'g'riligini tasdiqlayman
           </button>
...
<form style="display: none" method="post" id="hehe" action="<?php echo e(route('shartnoma.get')); ?>">
               <?php echo e(csrf_field()); ?>

               <input type="text" readonly="true" value="<?php echo e($data->id); ?>" name="data_id" hidden="true">
           </form>
