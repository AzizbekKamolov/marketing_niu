    ...
    <div class="col-md-8 ">
        <div class="row">
            ...
            <div style="display: inline-block; width: 49%" class="" >
                <span>2021 yil “<?php echo e($day); ?>” <?php echo e($month); ?></span>
            </div>
            ...
            <div class="col-md-12 mt-1 mb-1">
                <p>
                    ...
                    o’rinlarda “Universitet” deb nomlanuvchi bir tarafdan va <b><?php echo e($student->birthday); ?></b> yilda
                    tug’ilgan, pasport seriyasi
                    <b><?php echo e($student->passport_seria); ?></b> raqami <b><?php echo e($student->passport_number); ?></b>, universitet
                    talabasi <b><?php echo e($student->fio()); ?></b> keyingi
            ...
            <div class="col-md-12 mb-1">
                ...
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    3.2. Talaba xona va jihozlardan foydalanadigan o’quv yili uchun 100% oldindan <b><?php echo e($general_payment_sum ? number_format($general_payment_sum, 2, ',', ' ') :''); ?></b>
                    (<b><?php echo e(convert_to_word($general_payment_sum)); ?></b>) so’m miqdorida haq to’laydi.
                </p>
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                ...
                <table class="w-100">
                    ...
                    <tr>
                        ...
                        <td class="w-50" style="width: 49%">
                            ...
                            <p>
                                Pasport seriyasi <b><?php echo e($student->passport_seria); ?></b> raqami <b><?php echo e($student->passport_number); ?></b>
                            </p>
                            <p>
            ...
            <div class="col-md-12 text-center" style="padding-bottom: 50px">
                <button type="button" class="tasdiq btn btn-success">
                    Men , Talaba <b><?php echo e($student->fio()); ?></b> , Talabalar turar joyi uchun
                ...
                <form id="accept-form" action="<?php echo e(route('student.other_agreement.pdf_agreement')); ?>" method="post">
                    <?php echo e(csrf_field()); ?>

                    <?php echo e(method_field('POST')); ?>

                    <input type="text" hidden value="<?php echo e($student->id); ?>" name="student_id">
                    <input type="text" hidden value="<?php echo e($agreement->id); ?>" name="other_agreement_type_id">
                </form>
            </div>
