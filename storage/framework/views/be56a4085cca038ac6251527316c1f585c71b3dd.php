    ...
    <div class="col-md-8 ">
        <div class="row">
            ...
            <div class="col-md-6 text-center text-bold">
                ...
                <h4 class="text-bold"> №<?php echo e($student->id_code); ?></h4>
            ...
            <div class="col-md-12 ">
                <p>
                    &nbsp &nbsp &nbsp &nbsp <b>1.1.</b> 1.1. Mazkur Kontraktga asosan Ta’lim muassasasi Talabani
                    2021/2022 o‘quv yili davomida belgilangan ta’lim standartlari va o‘quv dasturlariga muvofiq
                    o‘qitadi, Talaba esa Kontraktning 3-bobida ko’rsatilgan tartib va miqdordagi to‘lovni amalga
                    oshiradi hamda Ta’lim muassasasida belgilangan tartibga muvofiq ta‘lim olish majburiyatini oladi.
                </p>
            </div>
            <div class="col-md-12 mb-1">
                <p>
                    &nbsp &nbsp &nbsp &nbsp <b>1.2.</b> Talabaning magistratura mutaxassisligini muvaffaqiyatli
                    tamomlash muddati
            ...
            <div class="col-md-12 mb-1">
                <p>
                    ...
                    to’lov summasi <b><?php echo e($student->all_summa); ?></b> (<?php echo e($student->all_summa_word); ?>) so‘mni tashkil etadi va
                ...
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    3.2. Talaba kuzgi semestr uchun <b><?php echo e($student->part1_summa); ?></b> ( <?php echo e($student->part1_summa_word); ?> )
                ...
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    3.3. Talaba bahorgi semestr uchun <b><?php echo e($student->part2_summa); ?></b> ( <?php echo e($student->part2_summa_word); ?>
