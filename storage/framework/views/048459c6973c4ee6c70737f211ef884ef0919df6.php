                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-8">
                                <div class="text-center">
                                    <h1 class="colorSix fw-bold fs-4">Talabalar turar joyi uchun to'lov shartnomasini olish</h1>
                                    <p class="text-danger">
                                ...
                                <form action="<?php echo e(route('student.agreement.show_agreement_ttj')); ?>" method="post" name="super-form"
                                    ...
                                    <input type="text" name="other_agreement_type_id" hidden value="1">
