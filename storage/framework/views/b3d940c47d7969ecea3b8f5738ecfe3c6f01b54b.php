        ...
        <div class="row">
            <div class="signup-content" style="margin: auto;">
                <div class="signup-form">
                   ...
                   <?php endif; ?>
                    <form action="<?php echo e(route('student.agreement.get_data')); ?>" method="post" name="super-form" class="register-form" id="register-form">
                        ...
                        <div class="form-group">
                            <span class="error" style="">
                                <?php if($errors->has('passport_seria')): ?>
                                        <?php echo e($errors->first('passport_seria')); ?>

                                    <?php endif; ?>
                            </span>
                            <label for="passport_seria">
                                <i class="zmdi zmdi-account-box-mail"></i></label>
                            <input type="text" name="passport_seria" id="passport_seria" value="<?php echo e(old('passport_seria')); ?>" placeholder="Pasport seriyasi"/>
                        </div>
                        <div class="form-group">
                             <span class="error" style="">
                                <?php if($errors->has('passport_number')): ?>
                                        <?php echo e($errors->first('passport_number')); ?>

                                    <?php endif; ?>
                            </span>
                            <label for="passport_number"><i class="zmdi zmdi-confirmation-number"></i></label>
                            <input type="text" name="passport_number" id="passport_number" value="<?php echo e(old('passport_number')); ?>" placeholder="Pasport raqami"/>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" onfocus="(this.type='date')" name="birthday" value="<?php echo e(old('birthday')); ?>" id="birthday" placeholder="Tug'ilgan sanasi"/>
