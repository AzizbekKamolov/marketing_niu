        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center text-bold">
                <h4 class="text-bold">
                    ...
                    (stipendiyasiz shaklda, <?php echo e($student->course); ?>-kurslar uchun)
            ...
            <div class="col-md-12 mb-1">
                <p>
                    ...
                    tomonidan to‘lanishi lozim bo‘lgan to‘lov summasi <b><?php echo e($student->all_summa); ?></b>
                    (<?php echo e($student->all_summa_word); ?>) so‘mni tashkil etadi va Kontraktning ushbu bobida belgilangan
                    tartibda to’lanadi.
                </p>
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    3.2. Talaba o’quv yilining birinchi yarmi uchun <b><?php echo e($student->part1_summa); ?></b>
                    (<?php echo e($student->part1_summa_word); ?>) so‘mni 2021 yilning 20 noyabrgacha to‘laydi.


                </p>
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    3.3. Talaba o’quv yilining ikkinchi yarmi uchun <b><?php echo e($student->part2_summa); ?></b>
                    (<?php echo e($student->part2_summa_word); ?>) so‘mni 2022 yilning 1 martgacha to‘laydi.
