                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="<?php echo e(route('payment_admin.student.update' , ['id' => $data->id])); ?>" class="form1" method="post">
                                ...
                                <div class="table-responsive" style="overflow-x: unset">
                                    <div class="row">
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" class="form-control" name="id_code" value="<?php if(old('id_code')): ?><?php echo e(old('id_code')); ?><?php else: ?><?php echo e($data->id_code); ?><?php endif; ?>">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                                Ism
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="date" class="form-control" name="birthday" value="<?php if(old('birthday')): ?><?php echo e(old('birthday')); ?><?php else: ?><?php echo e($data->birthday); ?><?php endif; ?>">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                                Telefon
                                            ...
                                            <input type="text" class="form-control" name="phone" value="<?php if(old('phone')): ?><?php echo e(old('phone')); ?><?php else: ?><?php echo e($data->phone); ?><?php endif; ?>">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                                Viloyat
                                            ...
                                            <select name="region" id="" class="form-control">
                                                ...
                                                <?php $__currentLoopData = $regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php if(old('region')): ?> <?php if(old('region')==$region->id): ?> selected <?php endif; ?> <?php else: ?> <?php if($data->region == $region->id): ?> selected <?php endif; ?> <?php endif; ?> value="<?php echo e($region->id); ?>"><?php echo e($region->name_uz); ?></option>
                                            ...
                                            <select name="area" id="" class="form-control">
                                                ...
                                                <?php if(old('region')): ?>
                                                    ...
                                                    <?php $__currentLoopData = $ar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option <?php if(old('area')): ?> <?php if(old('area')==$item->id): ?> selected <?php endif; ?> <?php else: ?> <?php if($data->area == $item->id): ?> selected <?php endif; ?> <?php endif; ?> value="<?php echo e($item->id); ?>"><?php echo e($item->name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php else: ?>
                                                    <?php
                                                    ...
                                                    ?>
                                                    <?php $__currentLoopData = $ar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option <?php if($data->area == $item->id): ?> selected <?php endif; ?>  value="<?php echo e($item->id); ?>"><?php echo e($item->name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                        ...
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                                ...
                                                <div style="display: flex; margin-top: 7px;" >
                                                    <input type="text" class="form-control" style="width: 30%" name="passport_seria" value="<?php if(old('passport_seria')): ?><?php echo e(old('passport_seria')); ?><?php else: ?><?php echo e($data->passport_seria); ?><?php endif; ?>">
                                                    <input type="text" class="form-control" style="width: 70%" name="passport_number" value="<?php if(old('passport_number')): ?><?php echo e(old('passport_number')); ?><?php else: ?><?php echo e($data->passport_number); ?><?php endif; ?>">
                                                </div>
                                            </label>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="date" class="form-control" name="passport_given_date" value="<?php if(old('passport_given_date')): ?><?php echo e(old('passport_given_date')); ?><?php else: ?><?php echo e($data->passport_given_date); ?><?php endif; ?>">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                            ...
                                            <input type="date" class="form-control" name="passport_issued_date" value="<?php if(old('passport_issued_date')): ?><?php echo e(old('passport_issued_date')); ?><?php else: ?><?php echo e($data->passport_issued_date); ?><?php endif; ?>">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                            ...
                                            <input type="text" class="form-control" name="passport_given_by" value="<?php if(old('passport_given_by')): ?><?php echo e(old('passport_given_by')); ?><?php else: ?><?php echo e($data->passport_given_by); ?><?php endif; ?>">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                                Jinsi
                                            ...
                                            <select name="gender" id="" class="form-control">
                                                <option <?php if(old('gender')): ?> <?php if(old('gender') == 1): ?> selected <?php endif; ?> <?php else: ?> <?php if($data->gender == 1): ?> selected <?php endif; ?> <?php endif; ?> value="1">Erkak</option>
                                                <option <?php if(old('gender')): ?> <?php if(old('gender') == 0): ?> selected <?php endif; ?> <?php else: ?> <?php if($data->gender == 0): ?> selected <?php endif; ?> <?php endif; ?> value="0">Ayol</option>
                                            </select>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                            ...
                                            <select name="type_degree" id="type_degree" class="form-control">
                                                <option <?php if($data->get_type()->degree == 1): ?> selected <?php endif; ?> value="1">Bakalavr</option>
                                                <option <?php if($data->get_type()->degree == 2): ?> selected <?php endif; ?> value="2">Magistr</option>
                                            </select>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                            ...
                                            <select name="status_new" id="status_new" class="form-control">
                                                ...
                                                <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php if(old('status_new')): ?> <?php if(old('status_new') ==$type->id): ?> selected <?php endif; ?> <?php else: ?> <?php if($data->status_new == $type->id): ?> selected <?php endif; ?> <?php endif; ?> value="<?php echo e($type->id); ?>">
