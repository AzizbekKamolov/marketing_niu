<?php $__env->startSection('content'); ?>
    <section class="section my-4 my-sm-2 my-md-2 my-lg-4 my-xl-5">
        <div class="container border border-2 rounded">
            <form action="<?php echo e(route('student.agreement.lyceum_show_agreement')); ?>" method="post" name="super-form" class="register-form" id="register-form">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input style="text-transform:uppercase" type="text" maxlength="2" name="parent_pass_seria"
                                               ...
                                               aria-describedby="inputGroupPrepend2" required value="<?php echo e(old('parent_pass_seria')); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="pasportNumber" name="parent_pass_number"
                                               aria-describedby="inputGroupPrepend2" required  value="<?php echo e(old('parent_pass_number')); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control" id="validationDefaultUsername" name="birthday"
                                               aria-describedby="inputGroupPrepend2" required  value="<?php echo e(old('birthday')); ?>">
                                    </div>
                                </div>
