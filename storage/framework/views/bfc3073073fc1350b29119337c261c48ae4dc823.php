...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/css/agreement.css')); ?>">
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center text-bold">
                <h4 class="text-bold">
                    ...
                    ikki tomonlama KONTRAKT (stipendiyali shaklda,kunduzgi  magistratura uchun )
                </h4>
                <h4 class="text-bold"> №________</h4>
                <h4 class="text-bold">ID: <b>002-00<?php echo e($student->id_code); ?></b></h4>
            </div>
            <div class="col-md-3"></div>
            ...
            <div class="col-md-6 text-right"><p><?php echo e($year); ?> yil “<?php echo e($day); ?>” <?php echo e($month); ?></p></div>
            <div class="col-md-12 mt-1 mb-1">
                <p>
                    ...
                    Islombek Rustambekovich bir tomondan, va <b><?php echo e($student->birthday); ?></b> yilda
                    tug’ilgan <b><?php echo e($student->fio()); ?></b> (keyingi o‘rinlarda – Talaba) ikkinchi tomondan (birgalikda –
                    ...
                    2021 yil
                    13 sentyabrdagi 02-252-son buyrug‘i, O’zbekiston Respublikasi ta’lim muassasalariga o’qishga qabul
            ...
            <div class="col-md-12 ">
                <p>
                    ...
                    o‘quv yili davomida belgilangan ta’lim standartlari va o‘quv dasturlariga muvofiq o‘qitadi, <b>Talaba</b>
                    esa <b>Kontraktning</b> 3-bobida ko’rsatilgan tartib va miqdordagi to‘lovni amalga oshiradi hamda
                    <b>Ta’lim
                        muassasasida</b> belgilangan tartibga muvofiq ta‘lim olish majburiyatini oladi.
                </p>
            </div>
            <div class="col-md-12 mb-1">
                <p>
                    &nbsp &nbsp &nbsp &nbsp <b>1.2.</b> <b>Talabaning</b> magistratura mutaxasisligini muvaffaqiyatli
                    tamomlash muddati
            ...
            <div class="col-md-12 mb-1 ">
                ...
                <p>
                    ...
                    talabalar safidan chetlashtirish yoki boshqa choralarni qo’llash, GPA ko‘rsatkichini to‘play
                    olmagan, semestr va o‘quv yili yakuni natijalari bo‘yicha akademik qarzdorligi bor Talabani tegishli
                    kursda qoldirish yoki boshqa choralarni qo‘llash.
                </p>
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    2.1.3.Talaba Ta’lim muassasasining ichki hujjatlarida belgilangan qoidalarni qo’pol ravishda buzgan,
                    xususan huquqbuzarlik sodir etgan hollarda Kontraktni bir tomonlama bekor qilish.
                </p>
                <p>
                    &nbsp &nbsp &nbsp &nbsp
            ...
            <div class="col-md-12 mb-1 ">
                ...
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    2.2.5. O’zbekiston Respublikasi Vazirlar Mahkamasining 2020 yil 31 yanvardagi 59-son qaroriga asosan
                    har oyda o‘rnatilgan muddat va tartibda stipendiya to‘lovlarini amalga oshirish.
                </p>
                <p>
                    &nbsp &nbsp &nbsp &nbsp
            ...
            <div class="col-md-12 mb-1">
                <p>
                    ...
                    lozim bo‘lgan to’lov summasi <b><?php echo e($student->all_summa); ?></b> (<?php echo e($student->all_summa_word); ?>) so‘mni
                    tashkil etadi va Kontraktning ushbu bobida belgilangan tartibda to’lanadi. Mazkur
                ...
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    3.2. Talaba kuzgi semestr uchun <b><?php echo e($student->part1_summa); ?></b> ( <?php echo e($student->part1_summa_word); ?> ) so‘mni quyidagi muddatlarda to‘laydi:
                    <br>1-oktyabrgacha -<?php echo e($student->part_four_1_summa); ?> so‘m;
                    <br>1-yanvargacha -<?php echo e($student->part_four_2_summa); ?> so‘m.


                </p>
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    3.3. Talaba bahorgi semestr uchun <b><?php echo e($student->part2_summa); ?></b> ( <?php echo e($student->part2_summa_word); ?> ) so‘mni quyidagi muddatlarda to‘laydi:
                    <br>1-aprelgacha -<?php echo e($student->part_four_3_summa); ?> so‘m;
                    <br>1-iyulgacha -<?php echo e($student->part_four_4_summa); ?> so‘m.
                ...
                <table class="w-100">
                    ...
                    <tr>
                        ...
                        <td class="w-50" style="width: 49%">
                            ...
                            <p class="word-line">
                                <b><?php echo e($student->fio()); ?></b>
                            </p>
                            <p class="w-100 text-center">
                                (F.I.Sh.)
                            </p>
                            <p>
                                Manzili: <b><?php echo e($student->address); ?></b>
                            </p>

                            <p>
                                Pasport seriyasi <b><?php echo e($student->passport_seria); ?></b> raqami
                                <b><?php echo e($student->passport_number); ?></b>
                            </p>
                            <p>
                                Tel: <b><?php echo e($student->phone); ?></b>
                            </p>
                            <p>
            ...
            <div class="col-md-12 text-center" style="padding-bottom: 50px">
                <div class="tasdiq btn-success "
                    ...
                    <p>
                        Men , Talaba <b><?php echo e($student->fio()); ?></b> , shartnoma mazmuni bilan to'liq tanishdim va uning
                        shartlariga roziman hamda shaxsiy ma`lumotlarim
                        to'g'riligini tasdiqlayman
                    </p>
                </div>
                <form id="accept-form" action="<?php echo e(route('student.agreement.pdf_agreement')); ?>" method="post">
                    <?php echo e(csrf_field()); ?>

                    <?php echo e(method_field('POST')); ?>

                    <input type="text" hidden value="<?php echo e($student->id); ?>" name="student_id">
                    <input type="text" hidden value="<?php echo e($agreement_type->id); ?>" name="agreement_type_id">
                    <input type="text" hidden value="<?php echo e($agreement_side_type->id); ?>" name="agreement_side_type_id">
                    <input type="text" hidden value="<?php echo e($getting_date); ?>" name="getting_date">
                </form>
            </div>
