...
ikki tomonlama KONTRAKT ( <?php if($data->step == 1 ): ?> <b>stipendiyali</b> <?php else: ?> <b>stipendiyasiz</b> <?php endif; ?>  shaklda, 2,3 va 4-kurslar uchun)
    </p>
    <p class="center bold">
        № ______
<br>
ID: <b>002-00<?php echo e($data->id_code); ?></b>
    </p>
    ...
    ?>
        ...
        <span style="float: right;">
            <?php if($data->getting_date): ?>
                <?php echo e(date('Y' , strtotime($data->getting_date))); ?> yil «<?php echo e(date('d' , strtotime($data->getting_date))); ?>» <?php echo e(get_month_name(date('m' , strtotime($data->getting_date)))); ?>

                <?php else: ?>
            <?php echo e(date('Y')); ?> yil «<?php echo e(date('d')); ?>» <?php echo e(get_month_name(date('m'))); ?>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    Toshkent davlat yuridik universiteti (keyingi o‘rinlarda – Ta’lim muassasasi) nomidan Ustavga asosan ish yurituvchi Rektor Xakimov Raxim Rasuljonovich bir tomondan, va <?php echo e($data->birthday); ?> yilda tug‘ilgan <span>
        <ul style="clear: both;">

    <li class="saaa">
        <p style="padding: 0;margin: 0;text-align: center">
          <b> <?php echo e($data->fio()); ?></b>
        </p>
...
(keyingi o‘rinlarda – <b>Talaba</b>) ikkinchi tomondan (birgalikda – <b>Tomonlar</b>), “Yurisprudensiya” ta’lim yo‘nalishi bo‘yicha <b> Talabani</b> bakalavriat 2020-2021 o'quv yili davomida o‘qitish maqsadida mazkur ikki tomonlama kontraktni (keyingi o‘rinlarda – <b> Kontrakt</b>)  Oliy va o‘rta maxsus, kasb-hunar ta’limi muassasalarida o‘qitishning to‘lov-kontrakt shakli va undan tushgan mablag‘larni taqsimlash tartibi to‘g‘risidagi nizom (ro‘yxat raqami 2431, 2013 yil 26 fevral), O‘zbekiston Respublikasi Vazirlar Mahkamasining 2019 yil 3 dekabrdagi 967-son qarori, Toshkent davlat yuridik universiteti rektorining 2020 yil 16 sentyabrdagi 02-121-son buyrug’iga muvofiq tuzdilar:
  ...
  <br/>
    ...
    <p>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    3.1. 2020/2021 o‘quv yilida <?php if($data->step == 1): ?> stipendiyali <?php else: ?> stipendiyasiz <?php endif; ?>  shaklda ta’lim olish uchun <b> Talaba </b> tomonidan to’lanishi lozim bo’lgan to’lov summasi pandemiya sharoitini inobatga olgan holda 10 (o’n) foiz chegirma bilan <?php if($data->step == 1): ?> <b> 13 940 117 </b> (O’n uch million to’qqiz yuz qirq ming bir yuz o’n yetti)  <?php else: ?> <b> 8 804 117 </b> (Sakkiz million sakkiz yuz to‘rt ming bir yuz o‘n yetti)  <?php endif; ?> so‘mni tashkil etadi va <b> Kontraktning </b> ushbu bobida belgilangan tartibda to’lanadi. Mazkur summa mehnatga haq to'lashning eng kam miqdori o’zgarishi bilan mos ravishda <b> Ta’lim muassasasi </b> tomonidan o’zgartirilishi mumkin.
     <br/>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    3.2. <b>Talaba</b> kuzgi semestr uchun <?php if($data->step == 1): ?> <b> 6 970 058 </b> (olti million to’qqiz yuz yetmish ming ellik sakkiz) <?php else: ?> <b> 4 402 058 </b> (to‘rt million to‘rt yuz ikki ming ellik sakkiz) <?php endif; ?> so‘mni quyidagi muddatlarda to’laydi:
     <br/>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    15-oktyabgacha -<?php if($data->step == 1): ?> 3 485 029 <?php else: ?> 2 201 029 <?php endif; ?> so’m;
     <br/>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    15-dekabrgacha -<?php if($data->step == 1): ?> 3 485 029 <?php else: ?> 2 201 029 <?php endif; ?> so’m.
    <br/>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    3.3. <b>Talaba</b> bahorgi semestr uchun  <?php if($data->step == 1): ?> <b> 6 970 059 </b> (olti million to’qqiz yuz yetmish ming ellik to'qqiz) <?php else: ?> <b> 4 402 059 </b> (to‘rt million to‘rt yuz ikki ming ellik to'qqiz) <?php endif; ?> so‘mni quyidagi muddatlarda to’laydi:
    <br/>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    15-fevralgacha -<?php if($data->step == 1): ?> 3 485 029 <?php else: ?> 2 201 029 <?php endif; ?> so’m;
    <br/>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    1-maygacha      -<?php if($data->step == 1): ?> 3 485 030 <?php else: ?> 2 201 030 <?php endif; ?> so’m.
    <br/>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 <p class="center bold">
    ...
    <div >
        <div class="abs1">
            ...
            <?php if($data->course == 1): ?>
            <img src="<?php echo e(public_path("pechat/pechat_yangi.png")); ?>" alt="" style="width: 110%; height: auto;">
            <?php else: ?>
            <img src="<?php echo e(public_path("pechat/pechat_yangi.png")); ?>" alt="" style="width: 110%; height: auto;">
            <?php endif; ?>
        ...
        <div class="abs2">
            ...
            <br/>
                Manzili: <?php echo e($data->address); ?>

            <br/>

                Pasport seriyasi: <b><?php echo e($data->passport_seria); ?></b>
                 <br>
                 Pasport raqami: <b><?php echo e($data->passport_number); ?></b>
            <br/>
            Tel: <b><?php echo e($data->phone); ?></b>
            <br>
            Imzo __________
...
Toshkent davlat yuridik universiteti nomidan Ustav asosida ish yurituvchi Rektor Xakimov Raxim Rasuljonovich (keyingi o‘rinlarda – Ta’lim muassasasi) bir tomondan va  talaba  <?php echo e($data->fio()); ?>  (keyingi o‘rinlarda – Talaba)  ikkinchi tomondan, tomonlar o’rtasida tuzilgan Toshkent davlat yuridik universitetida o’qitish uchun 2020 yil “_____” ____________dagi _____________________-son kontraktga quyidagilar haqida mazkur  Qo’shimcha kelishuvni tuzdilar:
        </p>
        <p style="padding-bottom: 2px !important; margin-bottom: 2px !important;">
