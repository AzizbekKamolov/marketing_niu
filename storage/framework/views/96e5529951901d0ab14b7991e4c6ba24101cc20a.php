            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="student_create" action="<?php echo e(route('payment_admin.student.store')); ?>" class="form1"
                              method="post">
                                ...
                                <fieldset class="scheduler-border ">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input required type="text" class="form-control" name="id_code"
                                                   value="<?php if(old('id_code')): ?><?php echo e(old('id_code')); ?><?php endif; ?>">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                                Ism
                                            ...
                                            <input required type="text" class="form-control" name="first_name"
                                                   value="<?php if(old('first_name')): ?><?php echo e(old('first_name')); ?><?php endif; ?>">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                                Familiya
                                            ...
                                            <input required type="text" class="form-control" name="last_name"
                                                   value="<?php if(old('last_name')): ?><?php echo e(old('last_name')); ?><?php endif; ?>">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                                Otasining ismi
                                            ...
                                            <input type="text" class="form-control" name="middle_name"
                                                   value="<?php if(old('middle_name')): ?><?php echo e(old('middle_name')); ?><?php endif; ?>">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                                Tug'ilgan sana
                                            ...
                                            <input required type="date" class="form-control" name="birthday"
                                                   value="<?php if(old('birthday')): ?><?php echo e(old('birthday')); ?><?php endif; ?>">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                                ...
                                                <?php if($errors->has('passport_seria')): ?>
                                                    ...
                                                    <?php if($errors->has('passport_seria_number')): ?>
                                                        | <?php echo e($errors->first('passport_seria_number')); ?> <?php endif; ?>
                                            </span>
                                                <div style="display: flex; margin-top: 7px;">
                                                    <input required type="text" class="form-control" style="width: 30%"
                                                           name="passport_seria"
                                                           value="<?php if(old('passport_seria')): ?><?php echo e(old('passport_seria')); ?><?php endif; ?>">
                                                    <input required type="text" class="form-control" style="width: 70%"
                                                           name="passport_number"
                                                           value="<?php if(old('passport_number')): ?><?php echo e(old('passport_number')); ?><?php endif; ?>">
                                                </div>
                                            </label>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            ...
                                            <select name="type_degree" id="" class="form-control">
                                                <option <?php if(old('type_degree') == 1): ?> selected <?php endif; ?> value="1">Bakalavr
                                                </option>
                                                <option <?php if(old('type_degree') == 2): ?> selected <?php endif; ?> value="2">Magistr
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            ...
                                            <select name="status_new" id="" class="form-control">
                                                <?php $__currentLoopData = $agreement_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-md-3 form-group ">
                                            <label for="">
                                                ...
                                                <div class="d-flex">
                                                    <span>Id kodni sms orqali talabaga jo`natish</span>
                                            <input type="checkbox"  class="form-control" name="send_id_code" style="width: 50px !important;">
                                                </div>
                                        </div>
                                    </div>
                                </fieldset>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 form-group">
                                            ...
                                            <select name="gender" id="" class="form-control">
                                                <option <?php if(old('gender') == '1'): ?> selected <?php endif; ?>  value="1">Erkak
                                                </option>
                                                <option <?php if( old('gender') == '0'): ?> selected <?php endif; ?>  value="0">Ayol
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <select name="region" id="" class="form-control">
                                                ...
                                                <?php $__currentLoopData = $regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php if(old('region')==$region->id): ?> selected
                                                            <?php endif; ?>  value="<?php echo e($region->id); ?>"><?php echo e($region->name_uz); ?></option>
                                            ...
                                            <select name="area" id="" class="form-control">
                                                ...
                                                <?php if(old('region')): ?>
                                                    ...
                                                    <?php $__currentLoopData = $ar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option <?php if(old('area')==$item->id): ?> selected
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" class="form-control" name="address"
                                                   value="<?php if(old('address')): ?><?php echo e(old('address')); ?><?php endif; ?>">
                                        </div>
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="date" class="form-control" name="passport_given_date"
                                                   value="<?php if(old('passport_given_date')): ?><?php echo e(old('passport_given_date')); ?><?php endif; ?>">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                            ...
                                            <input type="date" class="form-control" name="passport_issued_date"
                                                   value="<?php if(old('passport_issued_date')): ?><?php echo e(old('passport_issued_date')); ?><?php endif; ?>">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">
                                            ...
                                            <input type="text" class="form-control" name="passport_given_by"
                                                   value="<?php if(old('passport_given_by')): ?><?php echo e(old('passport_given_by')); ?><?php endif; ?>">
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
