        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center text-bold">
                <h4 class="text-bold">
                    ...
                    ikki tomonlama KONTRAKT (stipendiyasiz shaklda,kunduzgi  <?php echo e($student->course); ?> - kurslar uchun)
                </h4>
            ...
            <div class="col-md-12 mb-1">
                <p>
                    ...
                    lozim bo‘lgan to’lov summasi <b><?php echo e($student->all_summa); ?></b> (<?php echo e($student->all_summa_word); ?>) so‘mni tashkil etadi va Kontraktning ushbu bobida belgilangan tartibda to’lanadi. Mazkur summa
