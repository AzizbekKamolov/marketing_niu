        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center text-bold">
                <h4 class="text-bold">
                    ...
                    <br>
                    (stipendiyasiz shaklda, 2,3 va 4-kurslar uchun)
                </h4>
                <h4 class="text-bold">SHARTNOMASI № <?php echo e($student->id_code); ?></h4>
            ...
            <div class="col-md-6 text-right"><p><?php echo e($dateArray['year']); ?> yil “<?php echo e($dateArray['day']); ?>

                    ” <?php echo e($dateArray['month']); ?></p></div>
            <div class="col-md-12 mt-1 mb-1">
                <p>
                    ...
                    va
                    <b><?php echo e(date('Y-m-d' , strtotime($student->birthday))); ?></b>
                    yilda
                    tug’ilgan <b><?php echo e($student->fio()); ?></b> (keyingi oʻrinlarda – Talaba) ikkinchi tomondan (birgalikda –
                    Tomonlar), “Yurisprudensiya” taʻlim yoʻnalishi boʻyicha Talabani bakalavriat __ kurs davomida
            ...
            <div class="col-md-12 mb-1">
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    3.1.2022/2023-oʻquv yilida stipensiyasiz shaklda ta’lim olish uchun Talaba tomonidan toʻlanishi lozim
                    boʻlgan toʻlov summasi <b><?php echo e($student->all_summa); ?></b> (<?php echo e($student->all_summa_word); ?>)
                    soʻmni tashkil etadi va Shartnomaning ushbu bobida belgilangan tartibda toʻlanadi.
                </p>
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    3.2. Talaba kuzgi semestr uchun <b><?php echo e($student->part1_summa); ?></b>
                    ( <?php echo e($student->part1_summa_word); ?> )
                    so‘mni quyidagi muddatlarda to‘laydi:
                    <br>2022-yil 1-noyabrgacha - <b><?php echo e($student->part_four_1_summa); ?> so‘m;</b>
                    <br>2023-yil 1-yanvargacha - <b><?php echo e($student->part_four_2_summa); ?> so‘m.</b>


                </p>
                <p>
                    &nbsp &nbsp &nbsp &nbsp
                    3.3. Talaba bahorgi semestr uchun <b><?php echo e($student->part2_summa); ?></b>
                    ( <?php echo e($student->part2_summa_word); ?>

                    ) so‘mni quyidagi muddatlarda to‘laydi:
                    <br>2023-yil 15-aprelgacha - <b><?php echo e($student->part_four_3_summa); ?> so‘m</b>;
                    <br>2023-yil 1-iyulgacha -<b><?php echo e($student->part_four_4_summa); ?> so‘m</b>.
            ...
            <div class="col-md-12 text-center" style="padding-bottom: 50px">
                <div class="tasdiq btn-success "
                    ...
                    <p>
                        Men , Talaba <b><?php echo e($student->fio()); ?></b> , shartnoma mazmuni bilan to'liq tanishdim va
                        uning
