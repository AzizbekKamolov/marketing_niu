                    ...
                    <div class="card-body">
                        <div style="display: flex; justify-content: space-between; padding-bottom: 15px;">
                            ...
                            <?php if(Auth::user()->role == 11): ?>
                                <div>
                                    <a href="<?php echo e(route('payment_admin.student.create')); ?>" class="btn btn-success"
                            ...
                            <?php endif; ?>
                            <?php echo $__env->make('admin.pages.payment_admin.student.importModal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('payment_admin.student.show' , ['id' => $item->id])); ?>"
                                               class="" style="color: #000000"><?php echo e($item->fio()); ?></a>
                                        </td>
                                        <td>
                                        ...
                                        <?php if(Auth::user()->role == 11): ?>
                                            <td class="last-td">
                                                <a href="<?php echo e(route('payment_admin.student.payments' , ['id' => $item->id])); ?>"
                                            ...
                                            <td class="last-td">
                                                <a href="<?php echo e(route('payment_admin.student.check.edit' , ['id' => $item->id])); ?>"
