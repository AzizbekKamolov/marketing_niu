...
<div class="rekvizit">
    ...
    <div class="rekvizit-item"> 2020 йил « {{ date('d' , strtotime($data->getting_date)) }} » {{ get_month_name(date('m' , strtotime($data->getting_date))) }}</div>

    @else
    <div class="rekvizit-item"> 2020 йил « {{ date('d') }} » {{ get_month_name(date('m')) }}</div>
...
<div class="rekvizit" style="position: relative;">
    <div class="rekvizit-item" style="  position: absolute; left: 0; top: 0;">
            ...
            <img src="{{ public_path("pechat/pechat_lyceum.jpg") }}" style="width: 100%; height: auto; transform: scale(1.2);">
...
Паспорт серияси: <b>{{ $data->parent_pass_seria }}</b> рақами <b>{{ $data->parent_pass_number }}</b> <br>
