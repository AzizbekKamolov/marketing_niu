...
Бобоқулов Шохназар Очилович бир томондан, ва <b>{{ date('d-m-Y' , strtotime($data->birthday)) }}</b> йилда туғилган 
...
<div class="col-md-12 text-center mt-3">
    <button class="btn btn-success kollej-tasdiq" >Shartnoma shartlari bilan to'liq tanishib chiqdim , shartnoma shartlarga roziman va barcha ma'lumotlarim to'g'riligini tasdiqlayman</button>
</div>
</div>

<form action="{{ route('shartnoma.lyceum_get') }}" method="post" style="display: none;" >
	{{ csrf_field() }}
