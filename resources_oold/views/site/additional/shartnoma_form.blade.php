        ...
        <div class="row">
            <div class="signup-content" style="margin: auto;">
                <div class="signup-form">
                    <h2 class="form-title"> To'lov shartnoma qo'shimcha kelishuvi </h2><br>
                    ...
                    <form action="{{ route('shartnoma.info') }}" method="post" name="super-form" class="register-form" id="register-form">
                        ...
                        <div class="form-group" style="display: flex; flex-wrap: wrap;">
                             ...
                             <span class="error" style="">
                                ...
                                <input type="text" class="number-inputmask" name="id_code" id="id_code" autocomplete="off" value="{{ old('id_code') }}" placeholder=" Talaba ID raqami"/>
